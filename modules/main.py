...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://repgyetdcodkynrbxocg.supabase.co/storage/v1/object/public/images/telegram-1777229022494-fccd141e.jpg",
        caption=caption
    )
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"https://t.me/Courses_hub2_bot"), InlineKeyboardButton(text="🛠️ Repo", url="https://github.com")],
        ])
        ...
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [{CREDIT}⁬](https://t.me/Courses_hub2_bot", disable_web_page_preview=True, reply_markup=keyboard
        )
    else:
...
async def back_to_main_menu(client, callback_query):
    ...
    await callback_query.message.edit_media(
      InputMediaPhoto(
        media="https://repgyetdcodkynrbxocg.supabase.co/storage/v1/object/public/images/telegram-1777229022494-fccd141e.jpg",
        caption=caption
      ),
...
async def cmd(client, callback_query):
    ...
    await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://repgyetdcodkynrbxocg.supabase.co/storage/v1/object/public/images/telegram-1777229730720-2ad6dbb4.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
...
async def feature_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://repgyetdcodkynrbxocg.supabase.co/storage/v1/object/public/images/telegram-1777230095517-53de573d.jpg",
      caption=caption
    ),
    reply_markup=keyboard
  )
